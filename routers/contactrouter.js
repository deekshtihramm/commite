...
router.get('/', (req, res) => {
  const filePath = path.join(__dirname, '..', 'frontend', 'contact.html'); // Adjust the path as needed
...
router.get('/scrape', async (req, res) => {
  try {
    const filePath = path.join(__dirname, '..', 'frontend', 'contact.html'); // Update this path to your HTML file
