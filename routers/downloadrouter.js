...
router.get('/', (req, res) => {
  const filePath = path.join(__dirname, '..', 'frontend', 'download.html'); // Adjust the path as needed
...
router.get('/scrape', async (req, res) => {
  try {
    const filePath = path.join(__dirname, '..', 'frontend', 'download.html'); // Update this path to your HTML file
